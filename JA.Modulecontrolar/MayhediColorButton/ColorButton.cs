...
namespace ColorButton
{
	...
	public class ColorButton : System.Windows.Forms.Control
	{
        ...
        //private Color _HoverColorB = Color.Honeydew;

        private Color _NormalBorderColor = Color.PaleTurquoise;
        private Color _NormalColorA = Color.MediumTurquoise;
        private Color _NormalColorB = Color.Honeydew;

        private Color _HoverBorderColor = Color.MediumVioletRed;
        private Color _HoverColorA = Color.LemonChiffon;
        private Color _HoverColorB = Color.Honeydew;
