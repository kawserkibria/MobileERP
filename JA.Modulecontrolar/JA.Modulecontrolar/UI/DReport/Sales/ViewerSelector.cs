...
namespace JA.Modulecontrolar.UI.DReport.Sales
{
    public enum ViewerSelector
    {
        ...
        ProductSalesAllMPOSummary, MpoProductWiseSalesStatementQty, BKash, ProductSales12MonthQty, SalesCollectonperformance, SalesOrder, MpoProductWiseSalesStatementQty2,
        TCSalesCollection, CPSPSalescollPer, CollectionStatementRSM, CollectionStatementMPO, CollectionStatementFM, CollectionStatementZone,
        allMpoCollectionStatement, rptDailyCollectionRV, CollectionStatementIndividualF, rptMpoRouteWise, Pendingorder
    }
}
